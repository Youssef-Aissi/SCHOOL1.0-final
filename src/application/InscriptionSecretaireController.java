...
public class InscriptionSecretaireController implements Initializable {
	...
	ObservableList<String> options = FXCollections.observableArrayList("Enseignant","Etudiant");

	@Override
	public void initialize(URL arg0, ResourceBundle arg1) {
		// TODO Auto-generated method stub
		comboStatut.setItems(options);
		comboStatut.setValue("Enseignant");
